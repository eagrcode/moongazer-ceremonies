    ...
    <section id="planning-section">
      <div className="text-container">
        ...
        <p className="section-content">
          ...
          make sure that your script is just right for you.
        </p>
        <p className="section-content">
          Before the big day, you may like a rehearsal or you may not. We can discuss the individual
          benefits of this for your own distinct ceremony during the planning process.
        </p>
      </div>
    </section>
  );
